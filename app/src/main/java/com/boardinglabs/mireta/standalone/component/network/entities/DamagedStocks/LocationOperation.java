...
public class LocationOperation implements Serializable
{
    ...
    @SerializedName("total_damaged_stocks_count")
    @Expose
    private Integer totalDamagedStocksCount;
    @SerializedName("total_damaged_stocks_amount")
    @Expose
    private String totalDamagedStocksAmount;
    private final static long serialVersionUID = -6955372878846553936L;
    ...
    public Integer getTotalDamagedStocksCount() {
        return totalDamagedStocksCount;
    }

    public void setTotalDamagedStocksCount(Integer totalDamagedStocksCount) {
        this.totalDamagedStocksCount = totalDamagedStocksCount;
    }

    public String getTotalDamagedStocksAmount() {
        return totalDamagedStocksAmount;
    }

    public void setTotalDamagedStocksAmount(String totalDamagedStocksAmount) {
        this.totalDamagedStocksAmount = totalDamagedStocksAmount;
    }
