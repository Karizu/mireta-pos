...
//import com.boardinglabs.mireta.standalone.component.util.UiTools;
//
...
//
//    public SimpleListAdapter(Context context, ArrayList<String> strings, List<Detail> details) {
//        mContext       = context;
//        mStrings       = strings;
...
//    }
//
//    public Detail getItemDetail(int position) {
//        if (details != null && details.size() > 0)
//            return details.get(position - 1);
//        else
//            return null;
//    }
//
